...
const LandingPage = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-purple-600 to-indigo-400 min-h-screen text-white">
     ...
     <div>
        <button onClick={()=>{navigate('/login')}} className="bg-white text-purple-600 px-3 py-1 sm:px-4 sm:py-2 rounded-full font-semibold text-sm sm:text-base hover:bg-purple-100 transition duration-300">
              Login
        </button>
          </div>
        </nav>
      ...
      <main className="container mx-auto mt-8 sm:mt-12 px-4 text-center">
        ...
        <button onClick={navigate("/aboutus")} className="bg-white text-purple-600 px-4 py-2 sm:px-6 sm:py-3 rounded-full font-semibold text-base sm:text-lg hover:bg-purple-100 transition duration-300">
          More About Us
        </button>
      </main>
